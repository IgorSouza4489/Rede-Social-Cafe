# CafeJWTMVC
Projeto Rede Social Café utilizando .NET CORE 3.1, permite publicação de cafés pelos usuários e interação entre estes usuários por meio de comentários e notas.<Br>
